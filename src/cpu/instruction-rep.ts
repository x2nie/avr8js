  ...
  if ((opcode & 0xfc00) === 0x1c00) {
    ...
    cpu.data[(opcode & 0x1f0) >> 4] = cpu.readData(
      cpu.dataView.getUint16(28, true) +
        ((opcode & 7) | ((opcode & 0x0c00) >> 7) | ((opcode & 0x2000) >> 8))
    );
